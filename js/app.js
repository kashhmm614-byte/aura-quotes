...
class AuraApp {
  ...
  _cacheDOMElements() {
    this.elements = {
      ...
      modalNeon: document.getElementById('modalNeon'),
      btnOpenNeonModal: document.getElementById('btnOpenNeonModal'),
      btnCloseNeon: document.getElementById('btnCloseNeon'),
      formNeonConfig: document.getElementById('formNeonConfig'),
      ...
      neonStatusAlert: document.getElementById('neonStatusAlert'),
